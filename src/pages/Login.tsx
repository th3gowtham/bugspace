      ...
      <div className="w-full max-w-sm">
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full rounded-md border border-border bg-secondary py-2.5 text-sm font-medium text-secondary-foreground hover:bg-muted transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
