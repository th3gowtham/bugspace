...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden selection:bg-primary/20">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-[400px] h-[400px] bg-amber-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="mt-8 text-center text-sm font-medium text-muted-foreground animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          Promoter account?{" "}
          <Link to="/promoter/login" className="text-primary hover:text-primary/80 hover:underline transition-colors">Sign in to promoter portal</Link>
        </div>
